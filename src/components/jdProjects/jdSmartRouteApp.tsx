...
export function JdSmartRouteApp(): React.JSX.Element {
    return (
        <>
            ...
            <p>
                The majority of my design time was spent on the <strong>drag and drop interface</strong> for customizing return logic.
            </p>

            <p>
                While I was designing, I was also familiarizing myself with the browser's{' '}
                <JdATag href="https://developer.mozilla.org/en-US/docs/Web/API/HTML_Drag_and_Drop_API">drag and drop API</JdATag>.
            </p>
            ...
            <p>
                Eventually, I started to tie all of the objects together and started to work on the <strong>biggest challenge: custom rule overrides</strong>.
            </p>
            ...
            <p>
                Within about two months, I had gone from concepts to a production ready app with <strong>robust client customization and an endpoint for clients to use</strong>.
            </p>

            <p>
                We were gaining traction with <strong>three large national retailers</strong> who immediately saw the benefit of our app and the ease of use.
            </p>
        </>
    );
}
