...
export function JdTypoApp(): React.JSX.Element {
    return (
        <>
            ...
            <p>
                I'm familiar with the <JdATag href="https://reactnative.dev/docs/animated">RN Animated API</JdATag>, but I had been reading a lot about{' '}
                <JdATag href="https://docs.swmansion.com/react-native-reanimated/docs">Reanimated</JdATag> and really wanted to give it a shot.
            </p>
