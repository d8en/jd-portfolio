...
export function JdBoomNativeApp(): React.JSX.Element {
    return (
        <>
            ...
            <p>
                We integrated <strong>40+ stores</strong> and built interactions for stores that we weren't integrated with.
            </p>
            ...
            <p>
                We grew our beta group to <strong>200+ users</strong>, who submitted returns with pickups across <strong>20+ stores</strong>.
            </p>
