    ...
    return (
        <JdViewWrapper divProps={{ className: styles.homeContainer }}>
            ...
            <div className={styles.homeHeader}>
                ...
                {/* HEADLINE */}
                <h2 className={styles.homeSubHeader}><strong>Software engineer</strong> and <strong>product designer</strong> with 8 years of experience designing and building products.</h2>
            </div>
